...
function routes(app) {
    ...
    router.get('/get-docs-month-test', async (req, res) => {
        try {
            ...
            for (var i = 1; i < arrP.length; i++) {
                ...
                if (currentDate == arrP[i].date.getFullYear()) {
                    ...
                    // console.log("no entre al if ", i, arrP[i].date);
                }
            ...
            console.log("group list ", grouplist.length)

            var arrayFormartEnd = [];
            for (var i = 0; i < grouplist.length; i++) {
                arrayFormartEnd.push(getFormarArray(grouplist[i]))
            }
        ...
        for (var i = 0; i < arrP.length; i++) {
            switch (arrP[i].month) {
                case 1:
                    ...
                    break;
                case 2:
                    console.log("arrP february ", arrP[i].total)
                    averageFebruary = averageFebruary + Number(arrP[i].total)
                    contFebruary = contFebruary + 1;
                    break;
                case 3:
